<!-- Parked, not-started fix spec. Moved out of blueprint/context/current-feature.md
     on 2026-09-23 so the fallow cleanup could be specced and completed first.
     To resume: copy the content below (from the `# Fix:` heading) back into
     blueprint/context/current-feature.md and run /implement. -->
